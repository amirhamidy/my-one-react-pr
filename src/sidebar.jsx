...
const SideBarMenu = () => {
    ...
    return (
        <div className="main-box-sidebar py-2 px-1 col-md-2 align-items-center w-center">
            <span className="w-100 py-5" >
                <img alt="" className="w-25" src="../vite.svg" />
            </span>
            <div className="d-flex justify-content-start flex-column text-right list-box-sidebar mt-4">
                <span className="sidebar-list cs-fs-13 py-3 px-3 d-flex justify-content-start align-items-center active-sidebar-list">
                    <svg className="mx-2"
                ...
                <span className="sidebar-list cs-fs-13 py-3 px-3 d-flex justify-content-start align-items-center">
                    <svg className="mx-2"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 14 14"
                        width="1.2em"
